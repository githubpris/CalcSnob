...
public class Sobre extends javax.swing.JFrame {
    ...
    public Sobre() {
        ...
        this.setIconImage(new ImageIcon(getClass().getResource("/imagens/question.png")).getImage());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Desenvolvido por Jonathan Ribeiro (Tapia)");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/facebook_32.png"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/mail_32.png"))); // NOI18N
        jLabel3.setToolTipText("");

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 9)); // NOI18N
        jLabel5.setText("jonathan_dfi@hotmail.com");
